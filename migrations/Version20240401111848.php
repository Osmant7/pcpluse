 ...
 */
final class Version20240401111848 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `order` (id INT AUTO_INCREMENT NOT NULL, client_name VARCHAR(255) NOT NULL, delivery_address LONGTEXT DEFAULT NULL, quantity INT NOT NULL, order_cost INT NOT NULL, taxe INT DEFAULT NULL, order_cost_ttc INT NOT NULL, is_payed TINYINT(1) DEFAULT NULL, status VARCHAR(255) NOT NULL, carrier_price INT DEFAULT NULL, carrier_name VARCHAR(255) DEFAULT NULL, carrier_id INT DEFAULT NULL, updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
