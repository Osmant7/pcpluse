...
class __TwigTemplate_ca921eeb6ee802c37853d682e68a6af8 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div  class=\"section\">
        <div  class=\"container\">
           ";
        // line 9
        echo twig_get_attribute($this->env, $this->source, (isset($context["page"]) || array_key_exists("page", $context) ? $context["page"] : (function () { throw new RuntimeError('Variable "page" does not exist.', 9, $this->source); })()), "content", [], "any", false, false, false, 9);
        echo "
        </div>
    </div>
</div>
...
";
    ...
    {
        return array (  94 => 9,  89 => 6,  79 => 5,  59 => 3,  36 => 1,);
    }
...
{% block title %}PCpluse | {{page.title}}{% endblock %}
...
{% endblock %}
", "page/index.html.twig", "C:\\Users\\osman\\pcplus\\templates\\page\\index.html.twig");
    }
}
