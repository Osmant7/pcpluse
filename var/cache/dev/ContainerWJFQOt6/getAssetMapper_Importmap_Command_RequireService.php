...
class getAssetMapper_Importmap_Command_RequireService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->privates['asset_mapper.importmap.command.require'] = $instance = new \Symfony\Component\AssetMapper\Command\ImportMapRequireCommand(($container->privates['asset_mapper.importmap.manager'] ?? self::getAssetMapper_Importmap_ManagerService($container)), ($container->privates['asset_mapper'] ?? self::getAssetMapperService($container)), \dirname(__DIR__, 4));
